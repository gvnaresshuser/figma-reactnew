...
import { User, Calendar, Settings, ZapOff, MapPin, Settings2 } from "lucide-react";
...
`;
   ...
   /*      <div className="w-full max-w-[1440px] mx-auto px-4 
    bg-gradient-to-r from-[#0732b3] via-[#4CAF50] to-[#dee51e]  "> */
        <div className="w-full max-w-[1440px] mx-auto px-4 
    bg-[#000000]">
            ...
            <header className="relative w-full">
                ...
                <div className="flex justify-between items-center py-4">
                    ...
                    {/* LOGO */}
                    <div className="text-lg font-bold text-amber-100 z-80 ml-5">
                        <FaDraftingCompass size={45} className="text-cyan-400" />
                    </div>

                    {/* DESKTOP MENU */}
                    <div className="hidden md:flex gap-6 text-cyan-400 mr-10">
                        <div onClick={() => handleMenuClick("Home")}>Home</div>
                        <div onClick={() => handleMenuClick("About")}>About</div>
                        <div onClick={() => handleMenuClick("Services")}>Services</div>
                        <div onClick={() => handleMenuClick("Contact")}>Contact</div>
                    </div>

                
                    <div
                        className="md:hidden flex items-center justify-center w-8 h-8 cursor-pointer z-80"
                        onClick={() => setMenuOpen(!menuOpen)}
                    >
                        {menuOpen ? (
                            /* ❌ CROSS ICON */
                            <div className="relative w-6 h-6">
                                <span className="absolute top-1/2 left-0 w-6 h-[2px] bg-white rotate-45"></span>
                                <span className="absolute top-1/2 left-0 w-6 h-[2px] bg-white -rotate-45"></span>
                            </div>
                        ) : (
                            /* ☰ HAMBURGER */
                ...
                {menuOpen && (                           
                    ...
                    <div className="md:hidden absolute top-0 left-0 w-full h-screen bg-black
                     text-cyan-400 flex flex-col items-center justify-center gap-6 z-50">
                    
                        <div onClick={() => { setMenuOpen(false); handleMenuClick("Home"); }}>Home</div>
                        <div onClick={() => { setMenuOpen(false); handleMenuClick("About"); }}>About</div>
                        <div onClick={() => { setMenuOpen(false); handleMenuClick("Services"); }}>Services</div>
                        <div onClick={() => { setMenuOpen(false); handleMenuClick("Contact"); }}>Contact</div>
                    </div>            
            ...
            <div className="flex flex-col md:flex-row w-full min-h-screen">
                ...
                <section className="w-full md:w-1/2 mt-1">

                    <div className="relative w-full min-h-[500px] flex items-center justify-center overflow-hidden">
               
                {/* 🔹 TOP RIGHT SVGs */}            

                        <div className="absolute top-[10%] right-[8%] w-[110px] h-[110px]">

                        {/* 🔹 GROUP 1 (Responsive position) */}
                        <div className="absolute top-[15%] right-[10%] w-[120px] h-[110px]">

                            {/* Vector 3 (highlight stroke) */}
                            <svg
                                className="absolute left-[0%] top-[0%] rotate-[15deg]"
                                width="124"
                                height="121"
                            >
                            ...
                            {/* Vector 2 */}
                            <svg
                                className="absolute left-[30%] top-[65%] rotate-[8deg]"
                                width="120"
                                height="120"
                            >
                            ...
                            {/* Vector 1 - curve*/}
                            <svg
                                className="absolute left-[75%] top-[65%] rotate-[8deg]"
                                width="20"
                                height="20"
                            >
                                <path d="M1.50037 1.50038C7.46553 4.10105 19.3126 13.0767 18.9794 28.1741" stroke="#49C4DD" stroke-width="3" stroke-linecap="round" />
                            </svg>
                ...
                {/* 🔹 CENTER TEXT */}
                        ...
                        {/* 🔹 BOTTOM LEFT */}
                        <div className="mr-12 absolute bottom-15 md:bottom-4 flex justify-center items-center  gap-0">                            
                        <svg
                            width="200"
                            height="100"
                            viewBox="0 0 100 160"
                    ...
                    <div className="flex justify-center items-center gap-6 text-lg text-white py-4">
                                            
                            <div className="flex items-center gap-0.5">
                                <AiOutlineDisconnect size={18} className="text-gray-400" />
...
0 (min-x) → starting X position (left)
0 (min-y) → starting Y position (top)
5 (width) → total width of the coordinate system
800 (height) → total height of the coordinate system
*/
//https://www.figma.com/design/4zIRy3GEwII1bysHJNsZ4E/Travelers-%7C-Landing-Page---Mobile-App--Community-?node-id=315-21&p=f&t=0aZNkspCRJXZ9RoL-0
/*
What fill="white" means

👉 fill="white" sets the default color used to fill shapes inside the SVG.

So any element inside (like <path>, <rect>, <circle>, etc.) will:

be filled with white color
unless that element has its own fill specified
*/