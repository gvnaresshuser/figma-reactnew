...
//https://www.figma.com/design/c79hCAXZB2rIAT8NN8Z2j9/Travel-app-concept--Community-?node-id=0-10&t=hD6mHOhKhM5z4QrE-0
...
function DestinationCard({ dest, saved, onToggleSave }) {
    const handleMenuClick = (label) => {
        Swal.fire({
            ...
            background: "linear-gradient(to bottom right, #4338CA, #4F46E5, #6D28D9)",
            color: "#ffffff",
        });
    };
    return (
        <div className="group rounded-2xl overflow-hidden bg-white shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col">
            ...
            <div className="p-4 flex flex-col gap-3 flex-1">
                ...
                <div className="flex items-center justify-between mt-auto">
                    ...
                    <button onClick={() => handleMenuClick("Explore")} className="cursor-pointer bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white text-sm font-semibold px-4 py-2 rounded-xl transition">
                        Explore
                    </button>
                </div>
            </div>
...
export default function TravelApp6() {    
            ...
            <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
                        <a onClick={() => handleMenuClick("Destinations")} className="hover:text-indigo-600 transition cursor-pointer">Destinations</a>
                        <a onClick={() => handleMenuClick("Experiences")} className="hover:text-indigo-600 transition cursor-pointer">Experiences</a>
                        <a onClick={() => handleMenuClick("Community")} className="hover:text-indigo-600 transition cursor-pointer">Community</a>
                        <a onClick={() => handleMenuClick("About")} className="hover:text-indigo-600 transition cursor-pointer">About</a>
                    </div>
                    <div className="hidden md:flex items-center gap-3">
                        <button onClick={() => handleMenuClick("Sign in")} className="cursor-pointer text-sm font-medium text-gray-600 hover:text-gray-900 transition">Sign in</button>
                        <button onClick={() => handleMenuClick("Get Started")} className="cursor-pointer bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-4 py-2 rounded-xl transition">
                            Get Started
                        </button>
                    </div>
                    {/* Hamburger */}
                ...
                {menuOpen && (
                    <div className="md:hidden bg-white border-t border-gray-100 px-4 py-4 flex flex-col gap-4 text-sm font-medium text-gray-700">
                        {["Destinations", "Experiences", "Community", "About"].map((l) => (
                            <a key={l} onClick={() => handleMenuClick(l)} className="hover:text-indigo-600 transition cursor-pointer">{l}</a>
                        ))}
                        <div className="flex gap-3 pt-2 border-t border-gray-100">
                            <button onClick={() => handleMenuClick("Sign in")} className="cursor-pointer flex-1 text-center border border-gray-300 rounded-xl py-2 hover:bg-gray-50 transition">Sign in</button>
                            <button onClick={() => handleMenuClick("Get Started")} className="cursor-pointer flex-1 text-center bg-indigo-600 text-white rounded-xl py-2 hover:bg-indigo-700 transition">Get Started</button>
                        </div>
                    </div>
                )}
            </nav>
                        ...
                        <div className="flex gap-2 flex-wrap">
                            {categories.map((cat) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl text-sm font-semibold transition ${activeCategory === cat
